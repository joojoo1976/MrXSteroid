...
const buildContent = (): ContentStrings => ({
    ...
    timelineLabels: {
        ...
        appliedBiologyBadge: 'Applied Biology Science',
        statDetailedPhases: '4 Detailed Phases',
        statLiveProjections: 'Live Projections',
        statExpertTips: 'Expert Tips',
        unitSystemLabel: 'Unit system',
        bfMilestones: 'BF Milestones',
        expertTipBadge: 'Expert Tip',
        medicalSupervisionBadge: 'Medical Supervision',
        prevPhaseAria: 'Previous phase',
        nextPhaseAria: 'Next phase',
        muscleFatTitle: 'Muscle × Fat',
