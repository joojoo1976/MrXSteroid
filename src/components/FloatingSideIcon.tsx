...
const FloatingSideIcon: React.FC<{ isRTL: boolean }> = ({ isRTL }) => {
    return (
        ...
        >
            <div className={`bg-white dark:bg-card p-2 shadow-2xl border ${isRTL ? 'border-l-0 rounded-r-[2rem]' : 'border-r-0 rounded-l-[2rem]'} border-zinc-200 dark:border-zinc-800 transition-all hover:pr-4 hover:pl-4 group`}>
                <img
                    src="/icon.webp"
                    alt="Mr. X Icon"
