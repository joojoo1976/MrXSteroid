                    ...
                    <RevealOnScroll key={idx} delay={idx * 150}>
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-4 p-8 bg-zinc-50 dark:bg-background rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-xl relative overflow-hidden group hover:scale-[1.02] transition-all">
                                ...
                                <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-0 group-hover:w-3/4 h-2 bg-gradient-to-r from-gold-600 to-yellow-300 rounded-full transition-all duration-700 opacity-0 group-hover:opacity-100 shadow-[0_0_25px_rgba(255,255,160,0.6)] animate-shimmer"></div>
                            </div>
                        </motion.div>
                    </RevealOnScroll>
                ))}
