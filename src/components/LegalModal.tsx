...
const LegalModal: React.FC<{ isOpen: boolean; onClose: () => void; title: string; content: string; }> = ({ isOpen, onClose, title, content }) => {
    ...
    return (
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
            ...
            <div className="bg-white dark:bg-background w-full max-w-3xl h-[80vh] rounded-2xl shadow-2xl relative z-10 flex flex-col border border-zinc-200 dark:border-zinc-700 animate-fade-in-up">
                <div className="p-6 border-b border-zinc-200 dark:border-zinc-800 flex justify-between items-center bg-zinc-50 dark:bg-background rounded-t-2xl">
                    <h2 className="text-xl font-bold flex items-center gap-2"><FileText className="text-gold-500" /> {title}</h2>
