...
<ul>
    ...
    missionControl: {
        ...
        tagline: "Mr. X Steroid",
        collapse: "Collapse",
        searchPlaceholder: "Omni-search…",
        adminRole: "Admin",
        ...
        loading: "Synchronizing Global Assets…",
        overviewTitle: "Mission Overview",
        overviewSubtitle: "Real-time commerce intelligence",
        usdRevenue: "USD Revenue",
        egpRevenue: "EGP Revenue",
        pending: "Pending",
        unreadMessages: "Unread Messages",
        salesCount: "Sales",
        egyptVolume: "Egypt Volume",
        failedCount: "Failed",
        ordersCount: "Orders",
        revenueChartTitle: "Revenue (30 days)",
        ...
        manageBtn: "Manage",
        closeBtn: "Close",
        noOrdersFound: "No orders match the current filters.",
        ...
        deleteBtn: "Delete",
        replyByEmail: "Reply via Email",
        selectMessageHint: "Select a message to inspect.",
        receivedAt: "Received",
        orderRef: "Order",
        noMessagesFound: "No messages match the current filters.",
        logisticsTitle: "Logistics Command",
        logisticsSubtitle: "Dispatch management",
        activeUnits: "Active Units",
        unassignedOrders: "Unassigned Orders",
        assignDelegate: "Assign Delegate",
        allOrdersAssigned: "All orders are assigned.",
        noDelegates: "No delegates registered yet.",
        activeRuns: "active runs",
        unit: "Unit",
        settingsTitle: "Settings",
        settingsSubtitle: "Store & gateway configuration",
        ...
        deletedSuccess: "Message deleted.",
        deleteFailed: "Failed to delete message.",
        assignmentFailed: "Failed to assign delegate.",
        assignmentSuccess: "Order assigned to delegate.",
        gatewayStripe: "Stripe",
        gatewayPaymob: "Paymob",
        gatewaySpaceRemit: "SpaceRemit",
    }
};
