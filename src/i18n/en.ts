...
<ul>
    ...
    timelineCoach: {
        ...
        proteinNovice: "As a beginner your adaptation window is wide — lock in 2.2g/kg protein daily to ride it.",
        proteinIntermediate: "At intermediate level, 2.5g/kg protein keeps anabolic signaling at its peak.",
        proteinAdvanced: "Near your genetic ceiling — 2.8g/kg protein with disciplined recovery separates stalls from progress.",
