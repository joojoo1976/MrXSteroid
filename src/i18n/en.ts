...
<ul>
    ...
    halfLifeVisualizer: {
        title: "PharmaSim™ — Real-Time Pharmacokinetic Modeler",
        subtitle: "Clinically-informed simulation of compound accumulation, serum saturation curves, and PCT timing. Engineer your cycle. Control the pharmacology.",
        compoundLabel: "Substance / Compound",
        ...
        yAxis: "Serum Concentration",
        xAxis: "Days",
        pctZone: "PCT Recovery Window",
        pctStartMsg: "Initiate PCT Here",
        peakLevelMsg: "Peak Concentration",
        addToStackBtn: "Add to Protocol Stack",
        activeStackTitle: "Active Compound Stack",
        ...
        mgSerumLabel: "mg/L serum",
        loadLevelLabel: "Total Cumulative Load",
        estrogenRisk: "Aromatization & Estrogen Risk",
        prolactinRisk: "Prolactin Elevation Alert",
        riskLevels: { low: "Optimal", med: "Caution (Moderate)", high: "Critical (High Risk)" },
        emptyStackMsg: "No active compounds in simulator",
        emptyStackDesc: "Add substances to visualize pharmacological serum concentration levels and clearance dynamics over time.",
        hazardWarning: "CLINICAL WARNING: Elevated Dosage Threshold",
        compounds: commonCompounds,
        frequencies: { ed: "Every Day (ED)", eod: "Every Other Day (EOD)", e3d: "Every 3 Days (E3D)", e7d: "Weekly (E7D)" },
        tooltipDay: "Day",
        tooltipLevel: "Level",
        tooltipPctReady: "PCT Ready Status",
        tooltipWait: "HPTA Clearance Phase",
        tooltipInject: "Administration Day",
        analysis: {
            title: "Pharmacological Stack Analysis",
            prosTitle: "Clinical Advantages",
            consTitle: "Potential Side Effects & Risks",
            adviceTitle: "Mr. X's Verdict & Guidance",
            stabilityAdviceTitle: "Hormonal Stability Protocol",
            safetyAdviceTitle: "Risk Mitigation Strategy",
            pctTableTitle: "Suggested Post-Cycle Therapy (PCT)",
            pros: ["Stable serum concentrations", "Optimized administration frequency", "Reduced acute receptor shock"],
            cons: ["Extended clearance delay", "Prolonged shut-down window", "Requires high-precision PCT planning"],
            advice: "This simulator models how exogenous compounds saturate your bloodstream. Hormonal stability is the single most critical factor for avoiding side effects. Plan your PCT based on actual biological clearance.",
            pctNote: "This predictive recovery schedule is calculated based on cumulative compound clearance and HPTA suppression metrics. Blood work is mandatory to verify complete recovery.",
            protocolLevelLabel: "Protocol Complexity",
            recoveryPowerLabel: "HPTA Recovery Rating",
            tableHeaders: {
                compound: "Compound",
            ...
            stabilityExcellent: "Excellent hormonal stability curve.",
            stabilityFluctuation: "⚠️ Critical Fluctuations! We recommend increasing administration frequency (e.g. daily or EOD) to minimize spikes and valleys.",
            safetySafe: "Safety parameters within standard athletic tolerances.",
            safety19nor: "⚠️ 19-nor Compound Detected (Deca/Tren): Monitor prolactin carefully. Keep Cabergoline (0.25-0.5mg) on hand.",
            safetyAromatization: "⚠️ High Aromatization Risk: Keep a selective Aromatase Inhibitor (Arimidex/Aromasin) ready to control estradiol spikes.",
            pctStartPrefix: "Initiate PCT approximately ",
            pctStartSuffix: " days post-administration when compounds clear.",
            pctHeavy: "🚨 Ultra-Heavy Protocol: hCG support is mandatory. Closely monitor LH/FSH levels post-PCT.",
            pct19nor: "⚠️ 19-nor Active Residue: HPTA recovery may be significantly delayed. Consider extending PCT duration.",
            pctDaily: "Daily",
            pctEod: "EOD",
