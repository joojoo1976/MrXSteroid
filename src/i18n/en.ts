...
<ul>
    ...
    halfLifeVisualizer: {
        title: "PharmaSim™ — Real-Time Pharmacokinetic Engine",
        subtitle: "Clinically-calibrated simulation of compound accumulation, serum saturation kinetics, and PCT timing — engineered for precision pharmacological cycle management.",
        compoundLabel: "Compound / Ester Selection",
        dosageLabel: "Administered Dose (mg)",
        durationLabel: "Protocol Duration (Weeks)",
        startWeekLabel: "Protocol Initiation Week",
        frequencyLabel: "Administration Frequency",
        yAxis: "Serum Concentration (mg)",
        xAxis: "Day",
        pctZone: "PCT Recovery Window",
        pctStartMsg: "Initiate PCT Here",
        peakLevelMsg: "Peak Serum Concentration",
        addToStackBtn: "Add Compound to Stack",
        activeStackTitle: "Active Protocol Stack",
        serumTitle: "Pharmacokinetic Serum Profile",
        peakLabel: "Cmax (Peak Serum)",
        saturationTitle: "Saturation Threshold",
        stabilityTitle: "Hormonal Stability Index",
        consistencyLabel: "Stability Score",
        mgSerumLabel: "mg active / serum",
        loadLevelLabel: "Cumulative Hormonal Load",
        estrogenRisk: "Aromatization & Estradiol Risk",
        prolactinRisk: "Prolactin Elevation Alert",
        riskLevels: { low: "Optimal Range", med: "Moderate — Monitor", high: "Critical — High Risk" },
        emptyStackMsg: "Simulator Awaiting Input",
        emptyStackDesc: "Add compounds to your protocol stack to generate a real-time pharmacokinetic serum curve, PCT timing, and AI-powered hormonal analysis.",
        hazardWarning: "⚠ CLINICAL ALERT: Dosage Exceeds Standard Threshold",
        effectiveDoseLabel: "Active Free Dose (post-ester)",
        halfLifeInfoLabel: "Half-Life",
        clearanceInfoLabel: "Full Clearance (5×HL)",
        peakTimelineTitle: "Cycle Timeline",
        compoundBreakdownTitle: "Per-Compound Peak Analysis",
        clearanceChartLabel: "Clearance Curve",
        compounds: commonCompounds,
        frequencies: { ed: "Every Day (ED)", eod: "Every Other Day (EOD)", e3d: "Every 3 Days (E3D)", e7d: "Once Weekly (E7D)" },
        tooltipDay: "Day",
        tooltipLevel: "Serum Level",
        tooltipPctReady: "PCT Clearance Status",
        tooltipWait: "HPTA Suppression Phase",
        tooltipInject: "Injection Day",
        analysis: {
            title: "AI Pharmacological Stack Analysis",
            prosTitle: "Clinical Advantages",
            consTitle: "Risk Factors & Side Effects",
            adviceTitle: "Mr. X's Clinical Verdict",
            stabilityAdviceTitle: "Hormonal Stability Protocol",
            safetyAdviceTitle: "Risk Mitigation Strategy",
            pctTableTitle: "Precision Post-Cycle Therapy (PCT)",
            pros: ["Stable, predictable serum saturation", "Optimized injection frequency scheduling", "Minimized acute receptor desensitization"],
            cons: ["Extended biological clearance delay", "Prolonged endogenous HPTA suppression", "Requires precision PCT planning"],
            advice: "PharmaSim™ models how exogenous androgens accumulate in your bloodstream using the Bateman pharmacokinetic equation. Serum stability is the most critical determinant of side-effect risk. Engineer your cycle — don't guess it.",
            pctNote: "This AI-generated recovery protocol is calculated from cumulative hormonal load and biological clearance kinetics. Mandatory bloodwork (LH, FSH, Total-T, E2) is required to confirm full HPTA recovery before discontinuing PCT.",
            protocolLevelLabel: "Cycle Complexity Rating",
            recoveryPowerLabel: "HPTA Recovery Power",
            tableHeaders: {
                compound: "Compound",
                first10Days: "Loading Phase (1–10d)",
                weeks2to4: "Maintenance (Wks 2–4)",
                frequency: "Frequency"
            },
            stabilityExcellent: "✅ Excellent hormonal stability — smooth, consistent pharmacokinetic curve with minimal fluctuation.",
            stabilityFluctuation: "⚠️ High serum fluctuation detected. Increase injection frequency (daily or EOD) to smooth peaks and prevent receptor desensitization.",
            safetySafe: "✅ Risk parameters within clinically acceptable tolerances for the given protocol.",
            safety19nor: "⚠️ 19-nor androgen detected (Deca / Tren): Prolactin elevation is likely. Keep Cabergoline (0.25–0.5mg EOD) on hand throughout the cycle.",
            safetyAromatization: "⚠️ Elevated aromatization index: Implement an Aromatase Inhibitor (Anastrozole 0.5mg EOD or Exemestane 12.5mg EOD) to prevent estradiol-related side effects.",
            pctStartPrefix: "Begin PCT approximately ",
            pctStartSuffix: " days post-final dose — when biological clearance reaches 95% threshold.",
            pctHeavy: "🚨 Ultra-Heavy Protocol: hCG support is non-negotiable. Monitor LH, FSH, and Total-T levels via bloodwork after completing PCT to confirm recovery.",
            pct19nor: "⚠️ 19-nor Residue Active: HPTA recovery is significantly delayed. Extend PCT to a minimum of 6 weeks and confirm via bloodwork before discontinuing.",
            pctDaily: "Daily",
            pctEod: "EOD",
