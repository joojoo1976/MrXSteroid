...
<ul>
    ...
    injectionMap: {
        ...
        editPoints: {
          eyebrow: "Pin Position Tuning",
          title: "Align Injection Points Over the Exact Muscle",
          intro: "Because physiques differ, you can drag any point manually and permanently save its new location on this device.",
          dragHint: "Enable edit mode, then drag any point to the spot that matches the exact muscle.",
          saveHint: "The new position is saved permanently in this browser.",
          ...
          inactiveLabel: "Tap a point to select it",
        },
