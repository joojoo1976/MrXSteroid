...
<ul>
    ...
    timelinePhases: [
        { week: "1-2", weekStart: 1, weekEnd: 2, title: "The Kickstart", shortDesc: "Initial saturation and first changes", tagline: "The Spark — igniting your hormonal engine", iconKey: "spark", stats: { strength: 20, hypertrophy: 10, waterRetention: 30, fatLoss: 5, mood: 80 }, details: { biological: "Within the first 48 hours, exogenous androgens start suppressing your natural testosterone production while blood androgen levels climb sharply as the ester releases active hormone. Nitrogen retention in muscle tissue rises, glycogen is supercompensated, and muscle cells hold more water and creatine early — giving a fullness that is often mistaken for real growth.", feeling: "A surge of drive and confidence; libido typically peaks around week 2. You feel a constant pump during training, sleep runs deeper, and gym aggression rises noticeably. Oily skin and a warm sensation in the joints are common as androgen receptors begin saturating.", action: "Lock your nutrition to a strict surplus of {kcal} with {protein} of protein. Drink {water} of water daily. Train heavy compound lifts (3-4 sessions per week) but keep intensity controlled — the strength gain is real, so protect joints and tendons from loading up too fast. Benchmark every target against your current {weight} so the plan tracks your actual frame.", medical: "Estrogen conversion is already climbing. If you are prone to aromatization, start an AI only when symptoms actually appear — never preemptively. Do not add orals yet. Schedule a baseline blood panel (total testosterone, estradiol, AST/ALT, LDL/HDL, hematocrit) before week 3 so you have a comparison point." } },
        { week: "3-6", weekStart: 3, weekEnd: 6, title: "Hypertrophy Surge", shortDesc: "Rapid growth and weight gain", tagline: "The Golden Window — maximum anabolic drive", iconKey: "muscle", stats: { strength: 60, hypertrophy: 70, waterRetention: 50, fatLoss: 10, mood: 90 }, details: { biological: "Androgen receptors are now saturated and androgen-responsive genes transcribe at full capacity — muscle protein synthesis is roughly doubled. Satellite cell activation raises the ceiling for new myonuclei, meaning real structural growth rather than water. Insulin sensitivity is high, so nutrients are shunted into muscle tissue.", feeling: "The gym feels like cheat mode: workouts get intense, recovery is fast, and appetite is ravenous. Sleep quality stays high and libido remains elevated, though you may notice mood swings or mild irritability, especially if estrogen climbs too far.", action: "This is your anabolic window — drive progressive overload with 4-5 sessions per week, adding reps or load every week. Eat {protein} and {carbs} on training days. Monitor blood pressure twice weekly; if systolic exceeds 140 mmHg, cut sodium, add 3g of taurine, and reassess.", medical: "Watch for estrogen-related sides: itchy or puffy nipples, water bloat, and elevated blood pressure. If estradiol sides appear, use a low-dose AI and reassess — over-crashing estrogen wrecks lipid values and joints. Keep hydration above {water}, add citrus bergamot or fish oil for lipid support, and run a mid-cycle blood panel at week 6." } },
        { week: "7-10", weekStart: 7, weekEnd: 10, title: "Hardening Phase", shortDesc: "Weight stabilizes, fat burning starts", tagline: "Sculpting — density, detail and definition", iconKey: "trophy", stats: { strength: 90, hypertrophy: 90, waterRetention: 40, fatLoss: 40, mood: 70 }, details: { biological: "Blood levels stabilize at a steady plateau. Growth slows slightly as the body settles into homeostasis, while the surplus is now partitioned toward glycogen and hardness. Fat oxidation becomes more efficient, and as subcutaneous water recedes, the muscle built earlier becomes visible — the density effect.", feeling: "Muscles feel harder, fuller and more defined. Strength holds near peak and striations start appearing as water drops. Energy remains solid, though libido may soften as the body adapts to stable hormone levels.", action: "Shift toward conditioning: add 3-4 cardio sessions of 20-30 minutes and consider a modest carb reduction. Keep protein at {protein}. Train heavier with shorter rest to preserve density. Taper water and sodium only in the final two weeks if you are preparing for a specific date.", medical: "This is the highest-stress phase for liver and cardiovascular system. Get a full blood panel — hematocrit frequently climbs here; if it exceeds 54%, donate blood. Monitor LDL/HDL and liver enzymes, and do not run oral compounds beyond 8 weeks. If blood pressure creeps up, keep up taurine, {water} of daily water, and reduced sodium." } },
        { week: "11-12", weekStart: 11, weekEnd: 12, title: "Peaking", shortDesc: "Final touches before exit", tagline: "Peak Condition — race-day readiness", iconKey: "flag", stats: { strength: 100, hypertrophy: 100, waterRetention: 20, fatLoss: 60, mood: 60 }, details: { biological: "Muscle density and glycogen saturation peak while water retention sits at its lowest. Endogenous testosterone is fully suppressed, so mood and drive begin to taper. This is the transition window — the body is primed for the exit protocol.", feeling: "You look your full, hardest self: striations and vascularity at their best. But energy, motivation and mood may fade as hormone levels begin to dip, and sleep can become slightly restless. This is expected — not a warning sign.", action: "Prepare the PCT protocol now: choose your SERM, dose and start date (typically 2-3 weeks after your last injection depending on ester). Begin a modest calorie reduction and switch cardio to maintenance mode. Book your post-cycle bloodwork in advance.", medical: "Do not stop cold turkey. Start post-cycle therapy on schedule — using a SERM prematurely while androgens are still elevated is counterproductive, while delaying it risks a deep crash. Run blood tests 2 weeks after the last injection, watch for estrogen rebound, and keep total testosterone within range before considering anything new." } }
    ],
    timelineLabels: { strength: "Strength", hypertrophy: "Size", water: "Water", fatLoss: "Fat Loss", mood: "Mood", biologicalTitle: "Biological Impact", feelingTitle: "How You Feel", actionTitle: "Action Plan", medicalTitle: "Medical Advice", phaseLabel: "Phase", chartTitle: "Cumulative Evolution Plot", chartSubtitle: "AI-Driven Biometric & Performance Tracking", engineTitle: "Live Prediction Engine", engineSubtitle: "A rigorous physiological model, computed in real time", startWeightLabel: "Current Weight", bodyFatLabel: "Current Body Fat", trainingAgeLabel: "Training Age", trainingNovice: "Beginner (< 2 years)", trainingIntermediate: "Intermediate (2-5 years)", trainingAdvanced: "Advanced (5+ years)", weeklyFatLoss: "Weekly Fat Loss", weeklyMuscleGain: "Weekly Muscle Gain", cumulativeMuscle: "Cumulative Lean Mass", projectedFatPct: "Projected Body Fat", metric: "Metric", imperial: "Imperial", perWeek: "per week", disclaimer: "Figures are scientific projections based on established physiological models. Individual results vary with adherence and genetics.", heightLabel: "Height", goalProgress: "Goal Progress", idealWeightLabel: "Ideal Weight", timeToIdeal: "Time to Ideal Weight", projectedEndWeight: "Projected End Weight", totalFatLoss: "Total Fat Loss", totalMuscleGain: "Total Muscle Gained", dailyDeficit: "Daily Calorie Deficit", maintenanceCalories: "Daily Maintenance (TDEE)", bmiLabel: "BMI", currentBmi: "Current BMI", projectedBmi: "Projected BMI", weeksShort: "wk", targetDate: "Target date", withinCycle: "within cycle", beyondCycle: "beyond cycle", liveBadge: "LIVE", recalculating: "Recalculating", idealWeightReached: "Ideal weight reached", resetDefaults: "Reset inputs", copyPlan: "Copy plan", planCopied: "Plan copied to clipboard", maintenanceMode: "Maintenance — recomposition mode", weeklyTitle: "Week-by-Week Projection", weeklySubtitle: "The 12-week numbers behind the live chart", colWeek: "Week", colWeight: "Weight", colBodyFat: "Body Fat", colFatLoss: "Fat Lost", colLean: "Lean Gained", colCumulativeFat: "Cumulative Fat Lost", colLeanMass: "Lean Mass", phaseGroupLabel: "Phase", netWeightChange: "Net Weight Change", avgWeeklyFatLoss: "Avg Weekly Fat Loss", weeklyExpandHint: "Tap to expand / collapse", weeklyBfTrajectory: "Body-fat trajectory", compositionCardTitle: "Body Composition Quality", compositionCardSubtitle: "Live muscular × fat balance", compositionMuscle: "Lean Mass", compositionFat: "Fat Mass", compositionRatio: "Muscle : Fat", compositionQuality: "Quality Index", compositionMetabolism: "Metabolic State", compositionProjected: "Projected · Week 12", compositionZoneExcellent: "Elite composition — excellent muscle-to-fat balance.", compositionZoneGood: "Healthy composition — steady progress refines it further.", compositionZoneFair: "Moderate composition — the projected cycle keeps improving the balance.", compositionZoneImprove: "High body-fat base — the projected cycle restructures composition significantly.", metabolicEfficient: "High lean ratio → fast resting metabolism", metabolicBalanced: "Balanced lean ratio → normal resting metabolism", metabolicSluggish: "Lower lean ratio → slower resting metabolism", appliedBiologyBadge: "Applied Biology Science", statDetailedPhases: "4 Detailed Phases", statLiveProjections: "Live Projections", statExpertTips: "Expert Tips", unitSystemLabel: "Unit system", bfMilestones: "BF Milestones", expertTipBadge: "Expert Tip", medicalSupervisionBadge: "Medical Supervision", prevPhaseAria: "Previous phase", nextPhaseAria: "Next phase", muscleFatTitle: "Muscle × Fat", leanMassLabel: "Lean Mass", fatMassLabel: "Fat Mass", weeklyUnitShort: "wk" },
    ...
    timelineCoach: {
        ...
        verdictReached: "You are already at or below your ideal weight ({ideal}) — this cycle is about recomposition and holding the target. Keep protein high.",
        verdictMaintain: "You are inside your ideal weight band — the model projects recomposition with no net weight change. Track body-fat % rather than the scale.",
    ...
    contactOperatorIdentityLabel: "Full Name",
    contactSignalHashLabel: "Email Address",
    contactMissionTypeLabel: "Inquiry Type",
    contactTransmissionReferenceLabel: "Order Reference ID (Optional)",
    contactTransmissionHeaderLabel: "Subject",
    ...
    contactFormSubjectPlaceholder: "Subject of message...",
    contactMissionPayloadLabel: "Message / Inquiry Details",
    contactExecuteTransmissionBtn: "SEND MESSAGE NOW",
    contactSynchronizingBtn: "SENDING...",
    ...
    contactTransmissionProtocolLabel: "Secure Contact Form",
    contactEncryptedLabel: "Encrypted & Secure",
    contactSelectTopicPlaceholder: "Select Inquiry Type",
    ...
    missionControl: {
        ...
        pricingSubtitle: "Tier prices used by the server when charging. Edit freely — changes apply to new invoices.",
        pricingDigitalUsd: "Digital (USD)",
        pricingDigitalEgp: "Digital (EGP)",
        pricingBundleUsd: "Bundle (USD)",
        pricingBundleEgp: "Bundle (EGP)",
        pricingCoachingUsd: "Coaching (USD)",
        pricingCoachingEgp: "Coaching (EGP)",
        pricingCoachingPlusUsd: "Coaching+ (USD)",
        pricingCoachingPlusEgp: "Coaching+ (EGP)",
        pricingTolerance: "Amount tolerance (currency units)",
        pricingSave: "Save Pricing",
        catalogTitle: "Catalog & Inventory",
        catalogSubtitle: "Manage products, variants and stock",
        ...
        cancelBtn: "Cancel",
        productSaveSuccess: "Product saved.",
        ...
        categorySaveSuccess: "Category saved.",
        categorySaveFailed: "Failed to save category.",
        noCategories: "No categories yet.",
        categoryDeleteFailed: "Failed to delete category.",
        startTyping: "Start typing to search…",
        productImageCol: "Image",
        catalogFilterCategory: "All Categories",
        catalogFilterStatus: "All Statuses",
        marketingTitle: "Marketing & Promotions",
        marketingSubtitle: "Coupons, automatic rules and banners",
        ...
        maxPerUser: "Max Uses / User",
        startsAt: "Start Date",
        endsAt: "End Date",
        isActive: "Active",
        couponAddTitle: "Add Coupon",
        couponEditTitle: "Edit Coupon",
        saveCouponBtn: "Save Coupon",
        couponSaveSuccess: "Coupon saved.",
        couponSaveFailed: "Failed to save coupon.",
        couponDeleteSuccess: "Coupon deleted.",
        ...
        rulesTitle: "Automatic Discount Rules",
        addRuleBtn: "Add Rule",
        ruleName: "Rule Name",
        ruleType: "Rule Type",
        ...
        ruleTypeThreshold: "Spend threshold discount",
        ruleTypeBuyXY: "Buy X Get Y",
        ...
        bannerSaveSuccess: "Banner saved.",
        ...
        inactiveLabel: "Inactive customer",
        adminNotes: "Admin Notes",
        addNotePlaceholder: "Write an internal note about this customer...",
        addNoteBtn: "Add Note",
        noteAdded: "Note added.",
        noteAddFailed: "Failed to add note.",
        noteSaved: "Changes saved.",
        noteSaveFailed: "Failed to save changes.",
        ...
        cmsTitle: "Content (CMS)",
        cmsSubtitle: "Blog posts, pages and FAQ",
        blogTab: "Blog",
        pagesTab: "Pages",
        faqTab: "FAQ",
        blogAddTitle: "Add Blog Post",
        blogEditTitle: "Edit Blog Post",
        pageAddTitle: "Add Page",
        pageEditTitle: "Edit Page",
        faqAddTitle: "Add FAQ Item",
        faqEditTitle: "Edit FAQ Item",
        blogSlug: "Slug (URL)",
        pageSlug: "Slug (URL)",
        ...
        postCategoryEn: "Category (English)",
        postCategoryAr: "Category (Arabic)",
        faqCategoryEn: "Category (English)",
        faqCategoryAr: "Category (Arabic)",
        ...
        activeCol: "Active",
        saveBlogBtn: "Save Blog Post",
        savePageBtn: "Save Page",
        saveFaqBtn: "Save FAQ Item",
        cmsSaveSuccess: "Content saved.",
        cmsSaveFailed: "Failed to save content.",
        cmsDeleteSuccess: "Content deleted.",
        cmsDeleteFailed: "Failed to delete content.",
        noBlogPosts: "No blog posts found.",
        noCmsPages: "No pages found.",
        noFaqItems: "No FAQ items found.",
        langEn: "EN",
        langAr: "AR",
    }
};
