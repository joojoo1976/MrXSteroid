...
export enum Page {
  ...
  PAYMENT_DIAGNOSTIC = 'payment-diagnostic',
  FRAUD_ENGINE = 'evaluate-risk',
...
export interface ContentStrings {
  ...
  labTestsEn?: string;
  // ══════════════════════════════════════════════════════════════════════
  // Mission Control (Admin Dashboard) i18n
  // ══════════════════════════════════════════════════════════════════════
  missionControl?: {
    appName: string;
    tagline: string;
    ...
    unhandled: string;
    markHandled: string;
    markUnhandled: string;
    deleteBtn: string;
    replyByEmail: string;
    selectMessageHint: string;
    receivedAt: string;
    orderRef: string;
    ...
    endsAt: string;
    isActive: string;
    couponAddTitle: string;
    couponEditTitle: string;
    saveCouponBtn: string;
    couponSaveSuccess: string;
    couponSaveFailed: string;
    couponDeleteSuccess: string;
    couponDeleteFailed: string;
    discountTypePercentage: string;
    discountTypeFixed: string;
    discountTypeFreeShipping: string;
    ...
    ruleTypeThreshold: string;
    ruleTypeBuyXY: string;
    ruleSaveSuccess: string;
    ruleSaveFailed: string;
    ruleDeleteSuccess: string;
    ...
    bannerSaveSuccess: string;
    bannerSaveFailed: string;
    bannerDeleteSuccess: string;
    bannerDeleteFailed: string;
    noBannersFound: string;
    positionHome: string;
