-- ============================================================================
-- M1A — orders additive migration   (DRAFT — FOR REVIEW ONLY — DO NOT APPLY)
-- ----------------------------------------------------------------------------
-- Status : M1A SQL = DRAFT ONLY · M1B = NOT APPROVED · Production = UNTOUCHED
-- Design : docs/governance/phase1/M1-MINIMAL-ORDERS-MIGRATION-DESIGN.md (Rev 3)
-- Rule   : additive + backward-compatible ONLY. No NOT NULL, no M1B CHECKs,
--          no defaults, no price changes, no RLS/grant changes.
-- Safety : every object below cannot reject any current producer write
--          (0 orders rows; all new columns NULL today; producers never set
--          invoice_id/external_*/idempotency_key).
-- THIS FILE LIVES UNDER docs/governance/ and is NOT part of supabase/migrations,
-- so the MySQL/supabase migration runner will never pick it up.
-- ============================================================================
...
-- ─────────────────────────────────────────────────────────────────────────
-- END M1A DRAFT — intentionally absent: NOT NULL, all M1B CHECKs
...
-- Rollback: see M1A SQL REVIEW (section 4).
-- ============================================================================